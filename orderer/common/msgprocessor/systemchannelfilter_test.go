...
func TestGoodProposal(t *testing.T) {
	...
	configUpdate, err := encoder.MakeChannelCreationTransaction(newChainID, false, nil, genesisconfig.Load(genesisconfig.SampleSingleMSPChannelProfile, configtest.GetDevConfigDir()))
